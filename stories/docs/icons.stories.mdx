...
Please see the [definition](https://github.com/React-Artibox/artibox/tree/master/packages/icons/src/typings.ts) first.  
...
Or use the built in component [Icon](https://github.com/React-Artibox/artibox/tree/master/packages/slate-react/src/components/Icon/index.tsx) of artibox.
