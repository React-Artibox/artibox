import { createEditor as makeEditor, Descendant, Editor, Element, Node, Range, Text } from 'slate';
import {
  addAnchorToken,
  addFocusToken,
  AnchorToken,
...
const resolveDescendants = (children: any[]): Descendant[] => {
  ...
  const addChild = (child: Node | Token): void => {
    ...
    if (Text.isText(child)) {
      ...
      if (Text.isText(prev) && STRINGS.has(prev) && STRINGS.has(c) && Text.equals(prev, c, { loose: true })) {
        prev.text += c.text;
      } else {
        nodes.push(c);
      }
...
export function createAnchor(tagName: string, attributes: { [key: string]: any }): AnchorToken {
...
export function createCursor(tagName: string, attributes: { [key: string]: any }): Token[] {
...
export function createFocus(tagName: string, attributes: { [key: string]: any }): FocusToken {
...
export function createFragment(tagName: string, attributes: { [key: string]: any }, children: any[]): Descendant[] {
...
export function createText(tagName: string, attributes: { [key: string]: any }, children: any[]): Text {
...
export function createEditor(tagName: string, attributes: { [key: string]: any }, children: any[]): Editor {
